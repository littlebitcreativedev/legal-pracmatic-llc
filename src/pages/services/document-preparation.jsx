...
const DocumentPreparationPage = ({ location }) => {
  const intl = useIntl();

  return (
    <>
      <SEO lang={intl.locale} title={intl.formatMessage({ id: 'document-preparation' })} />
      <div className="service-views">
        <Container>
          <PageBanner
            title={intl.formatMessage({ id: 'document-preparation' })}
